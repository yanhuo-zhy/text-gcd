...
from config import cub_root, cub_tag_root

class CUB_Base(Dataset):
...
class CustomCub2011_LENS(CUB_Base):
    def __init__(self, root=cub_root, train=True, transform=None, target_transform=None, loader=default_loader, download=True):
...
class CustomCub2011(CUB_Base):
    def __init__(self, tag_root, root=cub_root, train=True, transform=None, target_transform=None, text_transform=None, loader=default_loader, download=True):
    ...
    def __getitem__(self, idx):
        ...
        return img, target, image_id, tag_token, self.uq_idxs[idx]
...
def get_cub_datasets(train_transform, 
    ...
    whole_training_set = CustomCub2011(root=cub_root, tag_root=tag_root,transform=train_transform, text_transform=text_transform, train=True, download=download)
    ...
    test_dataset = CustomCub2011(root=cub_root, tag_root=tag_root, transform=test_transform, text_transform=None, train=False)
