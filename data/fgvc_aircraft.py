...
from config import aircraft_root, aircraft_tag_root
...
class FGVCAircraft_Base(Dataset):
...
class FGVCAircraft_LENS(FGVCAircraft_Base):
    def __init__(self, root=aircraft_root, class_type='variant', split='trainval', transform=None, target_transform=None, loader=default_loader, download=False):
        super().__init__(root, class_type, split, transform, target_transform, loader, download)
    ...
    def __getitem__(self, index):
        ...
        return {"image": image, "target": target, "image_id": image_id, "id": self.uq_idxs[index]}

class FGVCAircraft(FGVCAircraft_Base):
    def __init__(self, root=aircraft_root, tag_root=None, class_type='variant', split='train', transform=None, target_transform=None, text_transform=None, loader=default_loader, download=False):
    ...
    def __getitem__(self, index):
        ...
        image_id = os.path.basename(path)
        tag_text = construct_text('A photo of an aircraft, ', self.tag[image_id])
        ...
        return image, target, image_id, tag_token, self.uq_idxs[index]
...
def get_aircraft_datasets(train_transform, 
                          test_transform, 
                          text_transform, 
                          tag_root=aircraft_tag_root,
    ...
    whole_training_set = FGVCAircraft(root=aircraft_root, tag_root=tag_root, transform=train_transform, text_transform=text_transform, split='trainval')
    ...
    test_dataset = FGVCAircraft(root=aircraft_root, tag_root=tag_root, transform=test_transform, text_transform=None, split='test')
