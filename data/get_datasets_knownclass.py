...
def get_datasets(dataset_name, train_transform, test_transform, text_transform, args):
    ...
    datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform, text_transform=text_transform,
    ...
    print("len of train_labelled",len(datasets['train_labelled']))
    print("len of train_unlabelled",len(datasets['train_unlabelled']))
    test_dataset = datasets['test']
    unlabelled_train_examples_test = deepcopy(datasets['train_unlabelled'])
    unlabelled_train_examples_test.transform = test_transform
    unlabelled_train_examples_test.text_transform = None
...
def get_class_splits(args):
    ...
    if args.dataset_name == 'cifar10':
        ...
        args.train_classes = range(int(args.prop_knownclass * 100))
        args.unlabeled_classes = range(int(args.prop_knownclass * 100), 100)
        ...
        if use_ssb_splits:
            ...
            # args.train_classes = range(80)
            # args.unlabeled_classes = range(80, 200)
