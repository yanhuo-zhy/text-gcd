...
from config import cifar_10_root, cifar_100_root, cifar_10_tag_root, cifar_100_tag_root


class CustomCIFAR10_Base(CIFAR10):

    def __init__(self, root=cifar_10_root, train=True, transform=None, target_transform=None, download=False):
...
class CustomCIFAR10_LENS(CustomCIFAR10_Base):
    def __init__(self, root=cifar_10_root, train=True, transform=None, target_transform=None, download=False):
...
class CustomCIFAR10(CustomCIFAR10_Base):
    def __init__(self, tag_root, root=cifar_10_root, train=True, transform=None, target_transform=None, text_transform=None, download=False):
...
class CustomCIFAR100_Base(CIFAR100):
    def __init__(self, root=cifar_100_root, train=True, transform=None, target_transform=None, download=False):
...
class CustomCIFAR100_LENS(CustomCIFAR100_Base):
    def __init__(self, root=cifar_100_root, train=True, transform=None, target_transform=None, download=False):
        super().__init__(root=root, train=train, transform=transform, target_transform=target_transform, download=download)
...
class CustomCIFAR100(CustomCIFAR100_Base):
    def __init__(self, tag_root, root=cifar_100_root, train=True, transform=None, target_transform=None, text_transform=None, download=False):
        self.tag = process_file(tag_root)
        self.text_transform = text_transform        
        super().__init__(root=root, train=train, transform=transform, target_transform=target_transform, download=download)
...
def get_cifar_10_datasets(train_transform, 
    ...
    whole_training_set = CustomCIFAR10(tag_root=tag_root, root=cifar_10_root, transform=train_transform, text_transform=text_transform, train=True)
    ...
    test_dataset = CustomCIFAR10(tag_root=tag_root, root=cifar_10_root, transform=test_transform, text_transform=None, train=False)
...
def get_cifar_100_datasets(train_transform, 
    ...
    # Init entire training set
    whole_training_set = CustomCIFAR100(tag_root=tag_root, root=cifar_100_root, transform=train_transform, text_transform=text_transform, train=True)
    ...
    # Get test set for all classes
    test_dataset = CustomCIFAR100(tag_root=tag_root, root=cifar_100_root, transform=test_transform, text_transform=None, train=False)
