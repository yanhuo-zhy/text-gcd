...
def train(student, train_loader, test_loader, unlabelled_train_loader, args):
    ...
    featurebank = FeatureBank(num_classes=args.mlp_out_dim, feature_dim=256, K=len(train_loader.dataset)//args.batch_size * args.batch_size)
...
class FeatureBank(nn.Module):
    def __init__(self, num_classes=200, feature_dim=256, K=128):
        ...
        self.register_buffer("u_bank", torch.zeros(self.K, self.feature_dim))
...
if __name__ == "__main__":
    ...
    init_experiment(args, runner_name=['scars'])
