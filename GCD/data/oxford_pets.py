...
class OxfordPet(OxfordIIITPet):

    def __init__(self, root=oxford_pet_root, split='trainval', transform=None, target_transform=None, download=False):

        super(OxfordPet, self).__init__(root=root, split=split, transform=transform, target_transform=target_transform, download=download)
...
def get_oxford_pets_datasets(train_transform, 
    ...
    whole_training_set = OxfordPet(root=oxford_pet_root, transform=train_transform)
    ...
    test_dataset = OxfordPet(root=oxford_pet_root, transform=test_transform, split='test')
