...
def train(projection_head, model, train_loader, test_loader, unlabelled_train_loader, args):
    ...
    for _, epoch in enumerate(range(args.epochs)):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='food', help='options: cifar10, cifar100, scars')
    ...
    parser.add_argument('--exp_name', default='GCD-food', type=str)
