...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch == 0:
            total_acc_text, old_acc_text, new_acc_text, total_acc_image, old_acc_image, new_acc_image = evaluate_two(model, val_loader, train_classes=args.train_classes)
        ...
        total_acc_w, old_acc_w, new_acc_w = evaluate_weighted(model, val_loader, train_classes=args.train_classes)
