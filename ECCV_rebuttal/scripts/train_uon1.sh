...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/rebuttal_cub_trainclassnums.txt
...
CUDA_VISIBLE_DEVICES=0 python train_classnums.py \
 ...
 --experiment_name='cub_train_classnums_seed0' \
...
CUDA_VISIBLE_DEVICES=0 python train_classnums.py \
 ...
 --batch_size=128 \
 --prop_train_labels=0.5 \
 --experiment_name='cub_train_classnums_seed1' \
 --output_dir='./rebuttal/train_classnums' \
...
CUDA_VISIBLE_DEVICES=0 python train_classnums.py \
 ...
 --batch_size=128 \
 --prop_train_labels=0.5 \
 --experiment_name='cub_train_classnums_seed2' \
 --output_dir='./rebuttal/train_classnums' \