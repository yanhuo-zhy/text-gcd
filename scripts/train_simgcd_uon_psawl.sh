...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/psawl/hyzheng/text-gcd/temp/temp_simgcd_cub_prop_knowclass4.txt
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.1 \
 --exp_name='True_SimGCD_cub_prob_knowclass(0.1)_seed2' \
 --print_freq=20
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_train_labels=0.5 \
 --prop_knownclass=0.2 \
 --exp_name='True_SimGCD_cub_prob_knowclass(0.2)_seed2' \
 --print_freq=20