...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/psawl/hyzheng/text-gcd/temp/temp_simgcd_cub_prop_knowclass3.txt
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.3 \
 --exp_name='True_SimGCD_cub_prob_knowclass(0.3)_seed1' \
 --print_freq=20
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_train_labels=0.5 \
 --prop_knownclass=0.4 \
 --exp_name='True_SimGCD_cub_prob_knowclass(0.4)_seed1' \
 --print_freq=20