...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_simgcd_cub_prop_trainlabels1.txt
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.5 \
 --exp_name='True_SimGCD_cub_prob_trainlabels(0.1)_seed1' \
 --print_freq=20
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.5 \
 --exp_name='True_SimGCD_cub_prob_trainlabels(0.2)_seed1' \
 --print_freq=20
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.5 \
 --exp_name='True_SimGCD_cub_prob_trainlabels(0.3)_seed1' \
 --print_freq=20
...
CUDA_VISIBLE_DEVICES=0 python SimGCD/train.py \
 ...
 --prop_knownclass=0.5 \
 --exp_name='True_SimGCD_cub_prob_trainlabels(0.4)_seed1' \
 --print_freq=20