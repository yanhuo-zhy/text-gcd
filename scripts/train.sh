...
#SBATCH --mem=30000
#SBATCH --gres gpu:1
#SBATCH -o /home/psawl/hyzheng/text-gcd/temp/temp_cifar100_3.txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --interrupted_path='' \
 --batch_size=128 \
 --experiment_name='cifar100_ablation_pseudo_ratio(0.8)'
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --interrupted_path='' \
 --batch_size=128 \
 --experiment_name='cifar100_ablation_pseudo_ratio(0.9)'