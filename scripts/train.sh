...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_cub_vith1.txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --pseudo_ratio=0.6 \
 --lambda_loss=0.2 \
 --coteaching_epoch_t=25 \
 --coteaching_epoch_i=25 \
 --seed_num=1 \
 --interrupted_path='' \
 --experiment_name='cub_vith_fixbackbone_warmup25-25'