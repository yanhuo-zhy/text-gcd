...
###
 ...
 # @LastEditTime: 2024-03-05 15:39:46
...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_eccv_flower_upbond2(1tag0att).txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --experiment_name='eccv_flowers_upbond2(1tag0att)'
