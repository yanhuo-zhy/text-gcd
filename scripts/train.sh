...
###
 ...
 # @LastEditTime: 2024-03-02 16:08:40
...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_eccv_imagenet100_wo_conloss.txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --experiment_name='eccv_imagenet_100_wo_conloss'
