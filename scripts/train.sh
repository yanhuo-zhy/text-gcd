...
###
 ...
 # @LastEditTime: 2024-01-27 17:01:54
...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_rebuttal_food_1-3.txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --coteaching_epoch_i=3 \
 --seed_num=1 \
 --interrupted_path='' \
 --batch_size=128 \
 --prop_train_labels=0.5 \
 --experiment_name='rebuttal_food_1-3_seed1'
