...
###
 ...
 # @LastEditTime: 2024-03-05 16:29:31
...
#SBATCH --mem=20000
#SBATCH --gres gpu:1
#SBATCH -o /home/pszzz/hyzheng/text-gcd/temp/temp_eccv_flower_upbond3(3tag0att).txt
...
CUDA_VISIBLE_DEVICES=0 python train.py \
 ...
 --experiment_name='eccv_flowers_upbond3(3tag0att)'
